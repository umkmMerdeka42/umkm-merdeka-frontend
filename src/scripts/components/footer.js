        ...
        <div class="md:px-12 lg:px-28">
          <div class="container m-auto space-y-6 text-gray-300">
            ...
            <div class="m-auto flex w-max items-center justify-between space-x-4">
              <a href="https://github.com/umkmMerdeka42" aria-label="github" class="hover:text-gray-600 transition-all text-3xl">
              ...
              <a href="https://www.instagram.com/nafasyarahma_" title="instagram" aria-label="facebook" class="hover:text-gray-600 transition-all text-3xl">
